...
#cgo LDFLAGS: -L./lib/ -lsamplerate -lm
#cgo CFLAGS: -I./lib/
...
func New(converterType int, channels int, bufferLen int, outputLength int) (Src, error) {
	...
	outputBuffer := make([]C.float, outputLength)
